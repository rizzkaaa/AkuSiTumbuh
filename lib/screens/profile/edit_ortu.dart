...
class EditOrtu extends StatefulWidget {
  final OrangTuaModel orangTua;
  const EditOrtu({super.key, required this.orangTua});

  @override
  State<EditOrtu> createState() => _EditOrtuState();
}

class _EditOrtuState extends State<EditOrtu> {
  ...
  void initState() {
    super.initState();
    final data = widget.orangTua;
    namaAnakController.text = data.childName;
    jenisKelamin = data.jenisKelamin;
    tanggalLahir = data.ttl;
  }
    ...
    if (_formKey.currentState!.validate()) {
      ...
      final result = await _service.updateProfile(
        ...
        orangTua: OrangTuaModel(
          childName: namaAnakController.text,
          ...
          child: Column(
            children: [
              ...
              DateInput(
                ...
                initialDate: widget.orangTua.ttl,
                onDateSelected: (date) {
